...
<html lang = "pt-pt">
    ...
    <body onselectstart="return false" data-spy="scroll" data-target="#myScrollspy" data-offset="50">
        ...
        <article style="padding-top: 100px;">
            <img src="layout/garfield.gif" class="gato">
            <br>
            <h3 style="text-align: center;">A página que está a procurar foi o gato que a comeu!</h3>
            <p style="text-align: center; margin-top: 5px;">Não tenha medo, existem outras coisas interessantes</p>
